    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.status === 200) {
            (0, _alert.showAlert)('success', 'logged in went successfully');
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = L.map('map', {
    ...
    minZoom: 3,
    // Prevent zooming out beyond zoom level 5
    maxZoom: 16,
    // Prevent zooming in beyond zoom level 10
    maxBounds: [[85, -180],
  ...
  locations.forEach(function (location) {
    ...
    marker.bindPopup("<p style=\"display : flex; justify-content:center; border-radius:0px; width:100%; height:100%; font-size:14px;\">Day ".concat(location.day, " : ").concat(location.description, "</p>"), {
      maxWidth: 300,
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51QnhNqRtFHUdKAxbEJkCugC8KxxP7MdJQdDZTvGFRd07ymrFpFuyvbEwtVw266PISPtRRvX2Z2aTPUTXyrF7fWGs00Coo3wiff');
